...
Namespace CQRS.EventHandling
    ...
    Public Class EventHub
        ...
        Public Shared Sub Publish(commandSource As IAmACommand, [event] As IAmAnEvent, Optional runAsync As Boolean = False)
            [event].CommandSource = commandSource
            Publish([event], runAsync)
        End Sub
